...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
        // Shoot in place (TR)
        driver.y()
            .whileTrue(superstructure.cacheState(driver)
            ...
            .onFalse(
                spindexer.stopSpindexer().alongWith(handoff.stopHandoffCommand())
            );
        
        driver.povLeft() 
            .whileTrue(intake.teleopDigest().repeatedly())
        ...
        driver.start()
            ...
            .whileTrue(new RepeatCommand(DriveCommands.buzzController(driver).onlyWhile(() -> !vision.hasData() && superstructure.getState() == SuperstructureState.SOTM)))
            .onTrue(new ConditionalCommand(
                ...
                new ParallelCommandGroup(
                    superstructure.SOTM().alongWith(new WaitUntilCommand(() -> superstructure.isReadyToShoot()))
        ...
        driver.back()
            ...
            .onTrue(new ConditionalCommand(
                ...
                new ParallelCommandGroup(
                    superstructure.FOTM().alongWith(new WaitUntilCommand(() -> superstructure.atTolerance()))
                        .andThen(handoff.runHandoffForward())
                        .andThen(spindexer.runSpindexerForward()),
        ...
        driver.x()
            .onTrue(
                new ParallelCommandGroup(
                    intake.runRollers(),
                    superstructure.leftCorner().alongWith(new WaitUntilCommand(() -> superstructure.atTolerance()))
                        .andThen(handoff.runHandoffForward())
                        .andThen(spindexer.runSpindexerForward()),
            ...
            .onFalse(superstructure.stow().alongWith(spindexer.stopSpindexer()).alongWith(handoff.stopHandoffCommand()));
        ...
        driver.b()
            ...
            .whileTrue(superstructure.rightCorner().alongWith(new WaitUntilCommand(() -> superstructure.atTolerance()))
                .andThen(handoff.runHandoffForward()).alongWith(new WaitUntilCommand(() -> handoff.getState() == HandoffState.FORWARD)
                .andThen(spindexer.runSpindexerForward())))
            .onFalse(superstructure.stow().alongWith(spindexer.stopSpindexer()).alongWith(handoff.stopHandoffCommand()));
        ...
        driver.a()
            ...
            .whileTrue(superstructure.kb().alongWith(new WaitUntilCommand(() -> superstructure.atTolerance()))
                .andThen(handoff.runHandoffForward()).alongWith(new WaitUntilCommand(() -> handoff.getState() == HandoffState.FORWARD)
                .andThen(spindexer.runSpindexerForward())))
            .onFalse(superstructure.stow().alongWith(spindexer.stopSpindexer()).alongWith(handoff.stopHandoffCommand()));
      }
