...
public class RobotContainer {
  ...
  private static LoggedNetworkNumber waitTimeOne = new LoggedNetworkNumber("/Tuning/Auton/Wait Time 1", 0.0);
  private static LoggedNetworkNumber waitTimeTwo = new LoggedNetworkNumber("/Tuning/Auton/Wait Time 2", 0.0);
  ...
  public void configureAutons() {
    ...
    // AutonConfig L_FNS_FN = new AutonConfig("Left Far-Near Shallow Far-Near", TwoCornerShallow::new,
    ...
    // AutonConfig R_FNS_FN = new AutonConfig("Right Far-Near Shallow Far-Near", TwoCornerShallow::new,
    ...
    // AutonConfig L_CN_NF = new AutonConfig("Left Corner-Near Near-Far", LeftTwoCornerVariant::new,
    ...
    // AutonConfig R_CN_NF = new AutonConfig("Right Corner-Near Near-Far", RightTwoCornerVariant::new,
    ...
    //RAN AT BATTLE CRY
    // AutonConfig R_CN_NFS = new AutonConfig("Right Corner-Near Near-Far-Short", TwoCornerShallow::new,
    ...
    // AutonConfig L_CN_NFS = new AutonConfig("Left Corner-Near Near-Far-Short", TwoCornerShallow::new,
    ...
    AutonConfig Right_Champs = new AutonConfig("Right Champs", TwoCorner::new,
    ...
    AutonConfig Left_Champs = new AutonConfig("Left Champs", TwoCorner::new,
    ...
    AutonConfig Left_Champs_NY = new AutonConfig("Left Champs NY", TwoCorner::new,
    ...
    AutonConfig Right_BC = new AutonConfig("Right BC", TwoCornerShallow::new,
    ...
    AutonConfig Left_BC = new AutonConfig("Left BC", TwoCornerShallow::new,
    ...
    //BC RIGHT
    // AutonConfig R_CN_FN_D = new AutonConfig("Right Corner-Near Far-Near Dot", TwoCornerBC::new,
    ...
    // AutonConfig R_CN_NF_D = new AutonConfig("Right Corner-Near Near-Far Dot", TwoCornerBC::new,
    ...
    // AutonConfig R_CN_FN_CD = new AutonConfig("Right Corner-Near Far-Near Center Dot", CenterTwoCornerBC::new,
    ...
    // AutonConfig R_CN_NF_CD = new AutonConfig("Right Corner-Near Near-Far Center Dot", CenterTwoCornerBC::new,
    ...
    //BC LEFT
    // AutonConfig L_CN_FN_D = new AutonConfig("Left Corner-Near Far-Near Dot", TwoCornerBC::new,
    ...
    // AutonConfig L_CN_NF_D = new AutonConfig("Left Corner-Near Near-Far Dot", TwoCornerBC::new,
    ...
    // AutonConfig L_CN_FN_CD = new AutonConfig("Left Corner-Near Far-Near Center Dot", CenterTwoCornerBC::new,
    ...
    // AutonConfig L_CN_NF_CD = new AutonConfig("Left Corner-Near Near-Far Center Dot", CenterTwoCornerBC::new,
