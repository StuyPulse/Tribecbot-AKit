...
public interface HoodConstants {
    ...
    public interface HoodSettings {
        ...
        final Angle FORWARD_SOFT_LIMIT =
            MAX_FROM_HORIZON.minus(SOFT_LIMIT);

        final Angle REVERSE_SOFT_LIMIT =
            MIN_FROM_HORIZON.plus(SOFT_LIMIT);
    ...
    public interface Angles {
        final LoggedNetworkNumber MANUAL_OVERRIDE_DEG =
            new LoggedNetworkNumber(
                "/Tuning/InterpolationTesting/Shoot State Target Angle (deg)",
                44.0);
