...
public interface TurretConstants {
    ...
    public interface TurretSettings {
        ...
        final LoggedNetworkNumber SOTM_TOLERANCE_THRESHOLD_METERS = new LoggedNetworkNumber(
                "/Tuning/Superstructure/Turret/SOTM Tolerance Dist Threshold (Meters)", 1.75);

        final LoggedNetworkNumber SOTM_TOLERANCE_CLOSE_DEG = new LoggedNetworkNumber(
                "/Tuning/Superstructure/Turret/SOTM Tolerance Close (Deg)", 10.0);

        final LoggedNetworkNumber SOTM_TOLERANCE_FAR_DEG = new LoggedNetworkNumber(
        ...
        final Translation2d TURRET_OFFSET = new Translation2d(
    ...
    public interface TurretGains {
        ...
        public interface slot1 {
            final LoggedNetworkNumber kP = new LoggedNetworkNumber("Superstructure/Turret/Gains/kP", 150.0);
            ...
            final LoggedNetworkNumber kS = new LoggedNetworkNumber("Superstructure/Turret/Gains/kS", 0.4775);
        ...
        final LoggedNetworkNumber kOmega = new LoggedNetworkNumber("Superstructure/Turret/Gains/kOmega", 3.43);
        final LoggedNetworkNumber kTranslation = new LoggedNetworkNumber("Superstructure/Turret/Gains/kTranslation",
                0.0);
    }
    ...
    public interface TurretMotorConfig {
        final TalonFXConfig TURRET_CONFIG = new TalonFXConfig()
                ...
                .withPIDConstants(TurretGains.slot1.kP.get(), TurretGains.slot1.kI.get(), TurretGains.slot1.kD.get(), 1)
                .withFFConstants(TurretGains.slot1.kS.get(), TurretGains.slot1.kV.get(), TurretGains.slot1.kA.get(), 1)
