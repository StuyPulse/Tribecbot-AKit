...
public interface SpindexerConstants {
    public interface Settings {
        ...
        final double IS_EMPTY_AMPERAGE = 10; // TODO: update IS EMPTY VALUE
    ...
    public interface MotorConfig {
        final TalonFXConfig SPINDEXER_LEAD_CONFIG = new TalonFXConfig()
        ...
        final TalonFXConfig SPINDEXER_FOLLOW_CONFIG = new TalonFXConfig()
                .withInvertedValue(InvertedValue.Clockwise_Positive)
                .withNeutralMode(NeutralModeValue.Brake)
