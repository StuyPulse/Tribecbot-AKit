...
public interface LEDConstants {
  public interface Settings {
    ...
    final SolidColor solidColorRequest = new SolidColor(0, LED_LENGTH - 1).withColor(new RGBWColor(Color.kRed));
    ...
    final double APRIL_TAG_DISTANCE_THRESHOLD = Units.feetToMeters(
