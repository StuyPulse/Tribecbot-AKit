...
public interface LEDConstants {
    public SolidColor solidColorRequest = new SolidColor(0, LEDConstants.LED_LENGTH - 1)
    ...
    public final int RIGHT_DEAD_START = LED_LENGTH - 6;
    public final int RIGHT_DEAD_END = LED_LENGTH - 2;

    public final int BACK_DEAD_START = LED_LENGTH - 13;
    public final int BACK_DEAD_END = LED_LENGTH - 9;

    public final int LEFT_DEAD_START = LED_LENGTH - 20;
    public final int LEFT_DEAD_END = LED_LENGTH - 16;

    public final int CANDLE_START = 0;
    public final int CANDLE_END = 7;
