...
public interface IntakeConstants {
    public interface Settings {
        ...
        final Current PUSHDOWN_CURRENT_TELEOP = Amps.of(
        ...
        final MomentOfInertia PIVOT_MOI = 
            KilogramSquareMeters.of(SingleJointedArmSim.estimateMOI(ARM_MASS.in(Kilograms), ARM_LENGTH.in(Meters)));
    }
    ...
    public interface Gains {
        public interface Pivot {
            final LoggedNetworkNumber kP = new LoggedNetworkNumber("/Tuning/Intake/Pivot/Gains/kP", 125.0);
    ...
    public interface MotorConfig {
        final TalonFXConfig PIVOT_CONFIG = new TalonFXConfig()
        ...
        final TalonFXConfig ROLLER_CONFIG = new TalonFXConfig()
                .withInvertedValue(InvertedValue.Clockwise_Positive)
