...
public class IntakeIOSim implements IntakeIO {
  ...
  public IntakeIOSim() {
    ...
    LinearSystem<N2, N1, N2> pivotSystem =
        LinearSystemId.createSingleJointedArmSystem(
            DCMotor.getKrakenX60(1), MOI, Settings.Intake.PIVOT_GEAR_RATIO);
    ...
    pivotController =
        new PIDController(
            Gains.Intake.Pivot.kP.get(), Gains.Intake.Pivot.kI.get(), Gains.Intake.Pivot.kD.get());

    SimpleMotorFeedforward ff =
        new SimpleMotorFeedforward(Gains.Intake.Pivot.kS.get(), Gains.Intake.Pivot.kV.get());
  ...
  public void updateInputs(IntakeIOInputs inputs) {
    ...
    inputs.rollerLeaderMotorVelocity =
        DegreesPerSecond.of(rollerLeaderSim.getAngularVelocityRadPerSec());
    ...
    inputs.rollerFollowerMotorVelocity =
