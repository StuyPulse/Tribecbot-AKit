...
public abstract class IntakeIOTalonFXBase<T extends TalonFX> implements IntakeIO {
    private final T pivotMotor;
    private final T rollerLeaderMotor;
    private final T rollerFollowerMotor;
    ...
    protected IntakeIOTalonFXBase(IntakeHardware<T> hardware) {
        this.pivotMotor = hardware.pivotMotor;
        this.rollerLeaderMotor = hardware.rollerLeaderMotor;
        this.rollerFollowerMotor = hardware.rollerFollowerMotor;
        ...
        this.rollerFollowerController = new Follower(rollerLeaderMotor.getDeviceID(), MotorAlignmentValue.Opposed);
