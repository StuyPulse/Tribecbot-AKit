    ...
    public TwoCornerShallow(PathPlannerPath... paths) {
        ...
        addCommands(
                ...
                Drive.getInstance()
                        ...
                        .alongWith(new WaitCommand(0.2).andThen(Intake.getInstance().deploy())),

                // Trip 1 To Score
                Drive.getInstance()
                        .followPathCommand(paths[1])
                        .alongWith(Superstructure.getInstance().autoInterpolation()),
                ...
                Superstructure.getInstance()
                        .autoInterpolation()
                        .alongWith(Intake.getInstance().setPivotStateCommand(PivotState.DEPLOY)),
